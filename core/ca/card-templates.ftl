...
card-templates-front-preview = Vista prèvia de l'anvers
card-templates-back-preview = Vista prèvia del revers
...
card-templates-discard-changes = Voleu descartar els canvis?
...
card-templates-deck-override = Reemplaçar el mall…
card-templates-delete-the-as-card-type-and = Voleu eliminar el tipus de targeta «{ $template }» i els seus { $cards }?
card-templates-enter-deck-to-place-new = Seleccioneu el mall en què voleu col·locar les { $val } noves targetes, o bé deixeu el camp en blanc:
...
card-templates-remove-card-type = Eliminar el tipus de targeta…
card-templates-rename-card-type = Canviar el nom del tipus de targeta…
