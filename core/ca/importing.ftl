...
importing-by-default-anki-will-detect-the = Per defecte, Anki detectarà alguns caràcter entre camps com ara un espai de tabulació, una coma o similar. Si Anki detecta el caràcter malament,  podeu introduir-lo aquí. Useu \t per a representar el tabulador.
