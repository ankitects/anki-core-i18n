...
preferences-media-is-not-backed-up = No s’ha fet cap còpia de seguretat dels fitxers multimèdia. Per motius de seguretat, feu una còpia de la carpeta d’Anki de manera periòdica.
