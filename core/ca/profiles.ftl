...
profiles-confirm-lang-choice = Estás segur que vols mostrar la interfície d'Anki en { $lang }?
profiles-could-not-create-data-folder = Anki no ha pogut crear la seva carpeta de dades. Consulta la secció Ubicacions de fitxers del manual i assegureu-vos que la ubicació no sigui de només lectura.
profiles-prefs-corrupt-title = Preferències Corrupte
profiles-prefs-file-is-corrupt = El fitxer prefs21.db d'Anki estava malmès i s'ha recreat. Si utilitzeu diversos perfils, torneu-los a afegir amb els mateixos noms per recuperar les teves targetes.
