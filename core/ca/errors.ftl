...
errors-filtered-parent-deck = Els malls filtrats no poden tenir malls secundaris.
errors-filtered-deck-required = Noméu podeu fer servir aquesta acció en un mall filtrat.
errors-100-tags-max =
