notetypes-notetype = Жазба Түрі

## Default field names in newly created note types

notetypes-front-field = Алды
notetypes-back-field = Арты
notetypes-add-reverse-field = Керісін Қосу
notetypes-text-field = Мәтін
notetypes-back-extra-field = Арты Қосымша

## Default note type names

notetypes-basic-name = Қарапайым
...
notetypes-card-1-name = 1-і Карта
notetypes-card-2-name = 2-і Карта
notetypes-add = Қосу: { $val }
notetypes-add-note-type = Жазба Түрін Қосу
notetypes-cards = Карталар
notetypes-clone = Көшіру: { $val }
notetypes-copy = { $val } көшіру
notetypes-create-scalable-images-with-dvisvgm = dvisvgm арқылы масштабталатын кескіндер жасаңыз
notetypes-delete-this-note-type-and-all = Бұл жазбаны және оның карталарын жою?
notetypes-delete-this-unused-note-type = Осы қолданылмаған жазба түрін жою?
