...
deck-config-limit-interday-bound-by-reviews =
    Қайталау шектеуі күнаралық оқу карталарына да әсер етеді. Шектеу
...
deck-config-new-insertion-order-tooltip =
    ...
    Мерзім нөмірі төмен карталар оқу кезінде алдымен көрсетіледі.
...
deck-config-bury-priority-tooltip =
    Anki карталарды жинағанда, алдымен бір күн ішіндегі оқу карталарын, кейін
    күнаралық оқу карталарын, одан соң қайталау карталарын, соңында жаңа
    ...
    ол күн аралық оқу немесе қайталау карталарын тыға алмайды, сондықтан бір сессияда
    қайталау тектесі де, жаңа тектесі де қатар көрінуі мүмкін.
...
deck-config-interday-step-priority = Күнаралық оқу/қайталау реті
deck-config-interday-step-priority-tooltip =
    Күн ауысу шегінен өткен (қайта)оқу карталарын көрсету уақыты.
    
    Қайталау шегі алдымен күнаралық оқу карталарына, содан кейін қайталау
    карталарына қолданылады. Бұл баптау жиналған карталардың көрсетілу
    ретін басқарады, бірақ күн аралық оқу карталары әрқашан бірінші жиналады.
