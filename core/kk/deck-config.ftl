...
deck-config-review-mix-mix-with-reviews = Шолулармен араластыру
# How new cards or interday learning cards are mixed with review cards.
deck-config-review-mix-show-after-reviews = Шолулардан кейін көрсету
# How new cards or interday learning cards are mixed with review cards.
deck-config-review-mix-show-before-reviews = Шолуларға дейін көрсету
