...
deck-config-interday-step-priority-tooltip =
    ...
    Шолу шегі алдымен күнаралық оқу карталарына, содан кейін қайталау карталарына қолданылады.
    Бұл баптау жиналған карталардың көрсетілу ретін басқарады, бірақ күн аралық оқу карталары әрқашан бірінші жиналады.
...
deck-config-review-sort-order-tooltip =
    ...
    егер шолу қоры жиналып қалса, алдымен ең көп күткендері шығады.
    Егер шолу қоры бірнеше күннен артық уақыт алатындай үлкен болса
