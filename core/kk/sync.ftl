...
sync-conflict-explanation =
    ...
    Барлық құрылғылар үйлестірілген кейін, болашақ шолу мен қосылған карталар автоматты түрде біріктіріледі.
...
sync-sanity-check-failed = Дерекқорды тексеру функциясын пайдаланыңыз, сосын қайтадан үйлестіру жасаңыз. Егер проблемалар сақталса, параметрлер экранында біржақты үйлестіру жасауды мәжбүрлеңіз.
...
sync-upload-too-large =
    ...
    колодаларды (еркіңізбен әкетіп) жойып, содан кейін дерекқорды тексеру
