...
database-check-new-card-high-due = Мерізімі >= 1,000,000 { $count } жаңа карта табылды. Шолғыш экранына жылжытуды қарастырыңыз.
...
database-check-title = Дерекқорды Тексеру
