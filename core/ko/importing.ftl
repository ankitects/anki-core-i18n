...
importing-mnemosyne-20-deck-db = Mnemosyne 2.0 뭉치 (*.db)
...
importing-this-will-delete-your-existing-collection = 기존의 모음집을 삭제하고 가져오려는 파일에 들어있는 자료로 대체할 것입니다. 계속 진행할까요?
