media-error-executing = Eksekusi { $val } gagal.
media-error-running = Gagal menjalankan { $val }
media-for-security-reasons-is-not = Demi keamanan, '{ $val } dilarang pada kartu. tempatkan perintah dalam paket lain dan impor melalui header LaTeX sebagai alternatif.
