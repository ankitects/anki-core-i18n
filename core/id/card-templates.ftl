...
card-templates-anki-couldnt-find-the-line-between = Anki tidak dapat menemukan garis antara pertanyaan dan jawab. tolong sesuaikan template secara manual untuk mengalihkan pertanyaan dan jawaban
card-templates-at-least-one-card-type-is = Setidaknya satu jenis kartu dibutuhkan.
card-templates-browser-appearance = Penampilan Browser...
card-templates-card = Kartu { $val }
...
card-templates-flip = Balik
card-templates-form = Bentuk
card-templates-off = (off)
card-templates-on = (on)
card-templates-remove-card-type = Hapus Jenis Kartu...
card-templates-rename-card-type = Rename Jenis Kartu...
card-templates-reposition-card-type = Reposisi Jenis Kartu...
