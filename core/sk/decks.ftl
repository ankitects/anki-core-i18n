...
decks-delay-for-button = Trvanie pre { $button }
# The count of cards waiting to be reviewed
decks-zero-minutes-hint = (0 = vrátiť kartičku do pôvodného balíčka)
...
decks-deck = Balíček
decks-learn-header = Učené
decks-review-header = Na skúšanie
