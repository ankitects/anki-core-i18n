...
studying-card-suspended = Karta odložena.
...
studying-good = Dobré
studying-hard = Těžké
studying-it-has-been-suspended = Odložení provedeno.
...
studying-note-suspended = Poznámka odložena.
...
studying-suspend = Odložit
studying-suspend-note = Odložit poznámku
