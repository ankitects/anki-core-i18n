...
browsing-place-at-end-of-new-card = Vložit na konec fronty nových karet
browsing-place-in-review-queue-with-interval = Vložit do fronty na opakování s rozestupy:
...
browsing-remove-current-filter = Odebrat současný filtr...
browsing-remove-from-your-saved-searches = Odebrat { $val } z uložených hledání?
...
browsing-save-current-filter = Uložit současný filtr...
