...
media-check-template-references-field-header =
    Το Anki δεν μπορεί να εντοπίσει τα χρησιμοποιημένα αρχεία όταν χρησιμοποιείτε αναφορές του τύπου { "{{Field}}" } στις ετικέτες media/LaTeX. Οι ετικέτες media/LaTeX θα πρέπει να τοποθετούνται στις μεμονωμένες σημειώσεις.
