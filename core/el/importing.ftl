...
importing-notes-skipped-update-due-to-notetype = Σημειώσεις που δεν ενημερώθηκαν, καθώ ο τύπος σημείωσης έχει τροποποιηθεί: { $val }
importing-notes-updated-as-file-had-newer = Σημειώσεις που ενημερώθηκαν, καθώς το αρχείο είχε μια νεότερη έκδοση: { $val }
...
importing-the-first-field-of-the-note = Το πρώτο πεδίο του τύπου σημείωσης πρέπει να αντιστοιχιστεί.
...
importing-update-if-newer = Αν είναι νεότερο
...
importing-update-notetypes-help = Πότε να ενημερώσετε έναν υπάρχοντα τύπο σημειώσεων στη συλλογή σας. Από προεπιλογή, αυτό γίνεται μόνο εάν ο αντίστοιχος εισαγόμενος τύπος σημειώσεων τροποποιήθηκε πιο πρόσφατα. Οι αλλαγές στο κείμενο του προτύπου και το στυλ μπορούν πάντα να εισαχθούν, αλλά για αλλαγές στον σχεδιασμό (π.χ. ο αριθμός ή η σειρά των πεδίων έχει αλλάξει), θα πρέπει επίσης να ενεργοποιηθεί η επιλογή '{ importing-merge-notetypes }'.
...
importing-allow-html-in-fields-help = Ενεργοποιήστε το εάν το αρχείο περιέχει μορφοποίηση HTML. Π.χ. αν το αρχείο περιέχει τη συμβολοσειρά '&lt;br&gt;', θα εμφανιστεί ως αλλαγή γραμμής στην κάρτα σας. Από την άλλη πλευρά, με αυτή την επιλογή απενεργοποιημένη, θα εμφανίζονται οι κυριολεκτικοί χαρακτήρες '&lt;br&gt;'.
