...
sync-resync-required = Παρακαλούμε κάνετε ξανά συγχρονισμό. Αν αυτό το μήνυμα συνεχίζει να εμφανίζεται, παρακαλούμε δημοσιεύεστε το στην ιστοσελίδα υποστήριξης.
sync-must-wait-for-end = Το Anki πραγματοποιεί συγχρονισμό. Παρακαλούμε περιμένετε την ολοκλήθωση του συγχρονισμού και μετά προσπαθήστε ξανά.
...
sync-sanity-check-failed = Παρακαλούμε χρησιμοποιήστε την λειτουργία Ελέγχου βάσης δεδομένων και μετά συγχρονίστε ξανά. Αν το πρόβλημα επιμένει, παρακαλούμε εξαναγκάστε έναν πλήρη συγχρονισμό στην οθόνη των προτιμήσεων.
