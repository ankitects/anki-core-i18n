...
card-templates-browser-appearance = Aspeto do navegador...
card-templates-card = Ficha { $val }
card-templates-card-types = Tipos de ficha
...
card-templates-delete-the-as-card-type-and = Eliminar o tipo de ficha '%(a)s' e os %(b)s?
