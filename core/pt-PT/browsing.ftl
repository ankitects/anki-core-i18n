...
browsing-find-duplicates = Encontrar Duplicados
browsing-first-card = Primeira ficha
browsing-flag = Bandeira
...
browsing-last-card = Última ficha
browsing-learning = (estudando)
browsing-line-size = <b>Tamanho da Linha</b>
browsing-manage-note-types = Gerir Tipos de Notas...
browsing-move-cards = Mover fichas
browsing-move-cards-to-deck = Mover fichas para o baralho:
browsing-new = (novo)
browsing-new-note-type = Novo tipo de nota:
browsing-no-flag = Sem Bandeira
...
browsing-search-bar-hint = Procurar fichas/notas (escreva e depois pressione Enter)
browsing-search-in = Procurar em:
browsing-search-within-formatting-slow = Procurar com formatação (lento)
browsing-select-deck = Seleccionar Baralho
browsing-selected-notes-only = Apenas as notas seleccionadas
...
browsing-tag-rename-warning-empty = Não pode renomear uma etiqueta que não tem notas.
browsing-target-field = Campo alvo:
browsing-toggle-bury = Adiar/Cancelar Adiamento
browsing-toggle-showing-cards-notes = Alternar entre Fichas e Notas
browsing-toggle-mark = Marcar/Desmarcar
browsing-toggle-suspend = Activar/Suspender
...
browsing-sidebar-collapse-children = Recolher Subcategorias
browsing-sidebar-decks = Baralhos
browsing-sidebar-tags = Etiquetas
browsing-sidebar-notetypes = Tipos de Nota
browsing-sidebar-saved-searches = Pesquisas Guardadas
browsing-sidebar-save-current-search = Guardar a Pesquisa Actual
browsing-sidebar-card-state = Estado da Ficha
...
browsing-tooltip-card = O nome do modelo duma ficha
browsing-tooltip-cards = O número de fichas associadas a uma nota
browsing-tooltip-notetype = O nome dum tipo de nota
browsing-tooltip-question = A frente duma ficha, personalizável no editor de modelos de fichas
browsing-tooltip-answer = O verso duma ficha, personalizável no editor de modelos de fichas
