preferences-anki-21-scheduler-beta = Pianificatore Anki 2.1 (beta)
...
preferences-hardware-acceleration-faster-may-cause-display = Accelerazione hardware (più veloce, può causare problemi di visualizzazione)
...
preferences-this-will-reset-any-cards-in = Questo azzererà tutte le carte in apprendimento, cancellerà i mazzi filtrati e cambierà la versione del pianificatore. Procedere?
