...
preferences-backup-explanation = Anki crea periodicamente delle copie di backup della tua collezione. I backup creati da più di 2 giorni¶ verranno via via rimossi per liberare spazio sul disco.
