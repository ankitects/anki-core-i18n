...
importing-rows-had-num1d-fields-expected-num2d = '%(row)s' possiedono %(num1)d campi, mentre ci si aspettava %(num2)d
...
importing-this-file-does-not-appear-to = Questi file sembra non essere un file .apkg valido. Se ottieni questo errore con un file scaricato da AnkiWeb, è probabile che lo scaricamento non è riuscito. Riprova, e se il problema rimane, prova di nuovo con un altro browser.
