...
scheduling-graduating-interval = Intervallo promozione
scheduling-hard-interval = Intervallo fisso
...
scheduling-set-for-all-subdecks = Imposta per tutti i sottomazzi
