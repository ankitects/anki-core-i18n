...
browsing-place-at-end-of-new-card = Posiziona alla fine della coda delle carte nuove
browsing-place-in-review-queue-with-interval = Inserisci nella coda delle ripetizioni con intervallo tra:
...
browsing-remove-current-filter = Rimuovi filtro attuale...
browsing-remove-from-your-saved-searches = Rimuovere { $val } dalle tue ricerche salvate?
...
browsing-save-current-filter = Salva il filtro attuale...
