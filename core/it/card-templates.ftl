...
card-templates-discard-changes = Abbandona le modifiche?
...
card-templates-at-least-one-card-type-is = È richiesta almeno una carta.
card-templates-browser-appearance = Aspetto del browser...
card-templates-card = Carta { $val }
card-templates-card-types = Tipi di carte
