...
scheduling-today-review-limit-reached =
    ...
    適切なタイミングでの復習によって記憶を維持するため、「オプション」で「一日の復習枚数の上限」を上げることを検討してください。
scheduling-today-new-limit-reached = 未導入の新規カードがまだ残っていますが、今日の新規カード導入枚数がすでに一日の上限に達しています。「オプション」で「一日の新規カード導入枚数の上限」を上げることも可能ですが、一日の導入枚数を増やすほど、その後、短めの間隔の復習が急増しやすくなることに注意してください。
