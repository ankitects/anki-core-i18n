...
scheduling-buried-cards-found = 手動操作またはオプションによる自動操作によって、今日の学習をパス（延期）したカードがあり、それらのカードは明日表示されます。{ $unburyThem }することで、それらのカードをただちに表示することもできます。
# used in scheduling-buried-cards-found
# "... you can unbury them if you wish to see..."
scheduling-unbury-them = パスを取り消し
...
scheduling-always-include-question-side-when-replaying = オーディオ再生の際、問題側のオーディオも必ず含める
...
scheduling-easy-interval = 「簡単」と回答してから復習開始までの間隔（日）
scheduling-end = (終了)
scheduling-general = 一般
scheduling-graduating-interval = 習得ステップ修了から復習開始までの間隔（日）
