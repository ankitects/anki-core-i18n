...
browsing-browser-appearance = 検索リストでの表示設定
browsing-browser-options = 検索オプション
browsing-buried = 今日パス
browsing-card = カード
browsing-cards = カード
...
browsing-tooltip-question = カードの表（おもて）側。カードテンプレートのエディターでカスタマイズすることができます。
browsing-tooltip-answer = カードの裏側。カードテンプレートのエディターでカスタマイズすることができます。
