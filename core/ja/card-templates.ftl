...
card-templates-browser-appearance = 検索の表示設定...
card-templates-card = カード{ $val }
card-templates-card-types = カードの種類
card-templates-card-types-for = ノート「{ $val }」が使用するカードタイプ
card-templates-cloze = 穴埋め
card-templates-deck-override = デッキを強制指定
card-templates-delete-the-as-card-type-and = カードタイプ '%(a)s'とその %(b)s を削除しますか？
...
card-templates-form = フォーム
card-templates-off =  (無効)
card-templates-on =  (有効)
