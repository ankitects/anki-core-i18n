...
deck-config-apply-all-parent-limits-tooltip =
    このオプションがオフ（デフォルト）の場合、各枚数の上限には、学習を開始する際に選択したデッキの設定および、その中のデッキ（サブデッキ）の設定がそれぞれ適用されます（なお、選択したデッキ内のサブデッキの設定は、上位のデッキの設定の範囲内で適用されます）。つまり、学習を開始する際にサブデッキを選択すると、それより上位のデッキの設定は無視されます。
    
    このオプションがオンの場合、各枚数の上限には、学習を開始する際に選択したデッキについての最上位のデッキ（メインデッキ）の設定および、その中のデッキ（サブデッキ）の設定がそれぞれ適用されます（デフォルトの場合と同様に、サブデッキの設定は、上位のデッキの設定の範囲内で適用されます）。「個々のサブデッキを選択して学習したいが、メインデッキで設定した枚数制限を守りたい」という場合に適した設定です。
