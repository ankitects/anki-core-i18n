...
deck-config-weights-tooltip2 =
    ...
    「最適化」ボタンを使うと、このプリセットを使用しているデッキにおけるこれまでの回答成績をもとに、あなた個人とそのデッキに最適化された値を使用することができます。
...
deck-config-compute-optimal-weights-tooltip2 =
    「最適化」ボタンを押すと、それまでの復習履歴が分析され、パラメータの値が置き換わります。その値は、あなたが学習内容（答え）を忘れてしまう前のタイミングで復習できるよう、あなたのそれまでの回答にもとづいて調整された値です。
