...
deck-config-apply-all-parent-limits-tooltip =
    このオプションがオフ（デフォルト）の場合、各枚数の上限には、学習を開始する際に選択したデッキの設定が適用されます。選択したデッキの中にデッキ（サブデッキ）がある場合は、選択したデッキの設定の範囲内で、サブデッキの設定が適用されます。さらに下位のサブデッキがある場合も同様に、上位のデッキの設定の範囲内で、下位のデッキの設定が適用されます。選択したデッキより上位のデッキの設定は無視されます。
    
    このオプションがオンの場合、各枚数の上限には、学習を開始する際にサブデッキを選択したとしても、最上位のデッキ（メインデッキ）の設定がまず適用されます。メインデッキ内の各サブデッキの設定も、デフォルトの場合と同様に、上位のデッキの設定の範囲内で適用されます。「個々のサブデッキを選択して学習したいが、メインデッキで設定した枚数制限を守りたい」という場合に適した設定です。
