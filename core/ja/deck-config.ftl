...
deck-config-limit-interday-bound-by-reviews = この枚数には、文字通りの復習カードだけでなく、その時点のステップが日をまたいでいる習得中（または再習得中）カードも含まれます。この枚数のカードが準備されるときは、ステップが日をまたいでいる習得中（または再習得中）カードが優先的に集められ、その後に復習カードが集められます。
