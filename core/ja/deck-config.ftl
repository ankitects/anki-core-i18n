...
deck-config-new-limit-tooltip =
    ...
    導入する新規カードの枚数が増加するほど、短期間での反復学習の量が一時的に増加し、過度な学習負荷につながります。そのため、一日あたりの新規カード出題枚数の上限は、一日あたりの復習カード出題枚数の上限の１０分の１以下とすることが推奨されます。
...
deck-config-bury-priority-tooltip =
    Ankiは学習画面に表示するカードを準備する際、準備リストにまず「習得ステップが１日以下の段階の習得中カード）を並べ、次に「習得ステップが１日より長い段階の習得中カード」、その次に復習カード、最後に新規カードを並べます。この並び方をもとに、どのカードを表示し、どのカードを延期するかが次のように決まります：
