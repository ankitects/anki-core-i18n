...
deck-config-bury-interday-learning-siblings = 兄弟関係の習得中カードで、ステップが日をまたいでいる場合は当日はパスする
...
deck-config-bury-priority-tooltip =
    Ankiは学習画面に表示するカードを準備する際、準備リストにまず「間隔が日付をまたいでいないステップにある習得中/再習得中カード」を並べ、次に「間隔が日付をまたいでいるステップにある習得中/再習得中カード」、その次に復習カード、最後に新規カードを並べます。この並び方をもとに、どのカードを表示し、どのカードを延期するかが次のように決まります：
