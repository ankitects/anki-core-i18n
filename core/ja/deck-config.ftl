...
deck-config-sort-order-card-template-then-random = カードタイプごとにランダム
deck-config-sort-order-random-note-then-template = ランダム（ノート）→カードタイプ
deck-config-sort-order-random = ランダム
deck-config-sort-order-template-then-gather = カードタイプ→集めたときの順序
