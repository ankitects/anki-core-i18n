...
importing-multicharacter-separators-are-not-supported-please = A többkarakteres elválasztójel nem támogatott. Kérjük, csak egy karaktert írjon be.
...
importing-this-file-does-not-appear-to = Úgy tűnik, ez nem érvényes .apkg fájl. Ha ezt a hibaüzenetet egy AnkiWebről letöltött fájlból kapta, a letöltés valószínűleg sikertelen volt. Kérjük, próbálja újra, és ha a probléma továbbra is fennáll, próbálkozzon egy másik böngészővel.
importing-this-will-delete-your-existing-collection = Ez a művelet törli a meglévő gyűjteményét, és a most importált fájlból származó adatokkal írja felül. Valóban ezt akarja?
