...
exporting-collection-exported = Gyűjtemény exportált.
...
exporting-include = <b>Beillesztés</b>:
exporting-include-html-and-media-references = HTML-lel és média-hivatkozásokkal együtt
