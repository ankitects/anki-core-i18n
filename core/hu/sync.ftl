...
sync-media-added-count = Hozzáadott: { $up }↑ { $down }↓
sync-media-removed-count = Törölt: { $up }↑ { $down }↓
...
sync-wrong-pass = Az AnkiWeb-azonosító vagy -jelszó nem megfelelő: kérlek, próbálkozz újra.
