...
browsing-add-tags = Dodaj etykiety
...
browsing-all-card-types = Wszystkie typy kart
browsing-all-fields = Wszystkie pola
browsing-answer = Odpowiedź
browsing-any-cards-mapped-to-nothing-will = Wszystkie karty nieprzypisane do niczego zostaną usunięte. Jeżeli w notatce nie pozostały żadne karty, zostanie ona utracona. Czy jesteś pewien, że chcesz kontynuować?
browsing-any-flag = Dowolna flaga
browsing-browser-appearance = Wygląd w przeglądarce
...
browsing-current-note-type = Aktualny typ notatki:
browsing-delete-notes = Usuń notatki
browsing-delete-tags = Usuń etykiety
browsing-duplicate = duplikat
browsing-ease = Łatwość
browsing-end = Zakończ
...
browsing-find-duplicates = Znajdź duplikaty
browsing-first-card = Pierwsza karta
...
browsing-in = <b>W</b>:
browsing-interval = Przerwa
browsing-last-card = Ostatnia karta
browsing-learning = (uczona)
browsing-line-size = <b>Rozmiar linii</b>:
...
browsing-override-front-template = Zmień szablon przodu:
browsing-place-at-end-of-new-card = Umieść na końcu kolejki nowych kart
browsing-place-in-review-queue-with-interval = Umieść w kolejce powtórek z przerwą pomiędzy:
browsing-please-give-your-filter-a-name = Podaj nazwę filtru:
browsing-please-select-cards-from-only-one = Wybierz karty tylko z jednego typu notatki.
browsing-preview-selected-card = Podgląd wybranej karty ({ $val })
browsing-question = Pytanie
...
browsing-sort-field = Sortuj pole
browsing-sorting-on-this-column-is-not = Sortowanie w tej kolumnie nie jest możliwe. Wybierz inną kolumnę.
...
browsing-sidebar-recent = Niedawne
browsing-sidebar-due-today = Na dziś
browsing-sidebar-due-tomorrow = Na jutro
