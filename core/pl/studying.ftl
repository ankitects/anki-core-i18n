...
studying-flag-card = Dodaj flagę do karty
studying-good = Dobra
studying-hard = Trudna
studying-it-has-been-suspended = Została zawieszona.
studying-manually-buried-cards = Ręcznie schowane karty
...
studying-this-is-a-special-deck-for = Specjalna talia do powtórek poza normalnym rozkładem.
studying-to-review = Do przejrzenia
