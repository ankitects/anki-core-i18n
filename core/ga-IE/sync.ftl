...
sync-confirm-empty-download = Níl aon cártaí sa chuasach logánta.  Íoslódáil ó AnkiWeb?
sync-conflict-explanation =
    De bharr an saghas difríochta idir na pacaí anseo agus ar AnkiWeb, ní féidir iad a chumasc.  Caithfear na pacaí ar thaobh amháin a fhorscríobh leis na pacaí ón taobh eile.
    
    Má roghnaíonn tú 'íoslódáil', déanfaidh Anki an cnuasach a Íoslódáil ó AnkiWeb, agus caillfear pé athruithe a rinne tú ar do ríomhaire tar éis an sioncronaithe is déanaí.
    
    Má roghnaíonn tú 'úaslódáil', déanfaidh Anki an cnuasach a uaslódáil chuig AnkiWeb, agus caillfear pé athruithe a rinne tú ar AnkiWeb (nó ar ghléas ar bith eile) tar éis an sioncronaithe is déanaí.
...
sync-sanity-check-failed = Úsáid an fheidhm 'Seiceáil Bunachar Sonraí', ansin déan sioncronú arís.  Muna réitíonn sé seo an fadhb, déan sioncronú iomlán faoi 'Roghanna'
