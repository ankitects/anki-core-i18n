...
importing-added-duplicate-with-first-field = Cuirtear dúblach leis, atá '{ $val }' mar chéad réimse aige.
importing-allow-html-in-fields = Ceadaigh HTML i réimsí
importing-anki-files-are-from-a-very = Baineann comhaid .anki le leagan fíorshean de Anki. Is féidir iad a iompórtáil le Anki 2.0, atá ar fáil ar suíomh gréasáin Anki.
...
importing-by-default-anki-will-detect-the = De réir réamhshocraithe, braithfidh Anki an carachtar idir réimsí (táb nó camóg, cuir i gcás).  Má bhraitheann Anki an carachtar mícheart, is féidir é a chuir isteach anseo.  Úsáid \t chun táb a chur isteach.
importing-change = Athraigh
importing-colon = Idirstad
importing-comma = Camóg
importing-empty-first-field = Céad réimse folamh: { $val }
...
importing-first-field-matched = Céad réimse faighte: { $val }
...
importing-map-to = Mapáil chuig { $val }
importing-map-to-tags = Mapáil chuig clibeanna
importing-mapped-to = mapáilte go <b>{ $val }</b>
importing-mapped-to-tags = mapáilte go <b>Clibeanna</b>
...
importing-notes-that-could-not-be-imported = Nótaí nár iompórtáladh de bharr athrú cló-aghaidhe: { $val }
...
importing-this-file-does-not-appear-to = Ní comhad bailí .apkg é seo. Má fuair tú ó AnkiWeb é, seans gur theip ar an íoslódáil. Bain triail eile as, agus má tá an fadhb agat fós, bain triail as le brabhsálaí eile.
