...
deck-config-starting-ease-tooltip = ସେହି ଗୁଣକ ଯାହା ସହିତ ନୂତନ ପତ୍ର ଆରମ୍ଭ ହୁଏ। ଡିଫଲ୍ଟ ଭାବରେ, ଏକ ନୂଆରେ ଶିଖିଥିବା ପତ୍ରରେ `ଭଲ` ବଟନ୍ ପରବର୍ତ୍ତୀ ସମୀକ୍ଷାକୁ ପୂର୍ବ ବିଳମ୍ବର 2.5 ଗୁଣ ବିଳମ୍ବ କରିବ।
deck-config-easy-bonus-tooltip = ଏକ ଅତିରିକ୍ତ ଗୁଣକ ଯାହା ଏକ ସମୀକ୍ଷା ପତ୍ରର ଅନ୍ତରାଳରେ ପ୍ରୟୋଗ କରାଯାଏ ଯେତେବେଳେ ଆପଣ ଏହାକୁ `ସହଜ` ବୋଲି ମୂଲ୍ୟାଙ୍କନ କରନ୍ତି।
