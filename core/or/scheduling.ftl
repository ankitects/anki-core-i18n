...
scheduling-your-changes-will-affect-multiple-decks = ଆପଣଙ୍କ ପରିବର୍ତ୍ତନଗୁଡ଼ିକ ଏକାଧିକ ଡେକ୍ କୁ ପ୍ରଭାବିତ କରିବ। ଯଦି ଆପଣ କେବଳ ସମ୍ପ୍ରତି ଡେକ୍ ପରିବର୍ତ୍ତନ କରିବାକୁ ଚାହୁଁଛନ୍ତି, ଦୟାକରି ପ୍ରଥମେ ଏକ ନୂତନ ବିକଳ୍ପ ଗୋଷ୍ଠୀ ଯୋଡ଼ନ୍ତୁ।
