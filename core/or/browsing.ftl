...
browsing-add-tags = ଟ୍ୟାଗ୍ ଯୋଡ଼ନ୍ତୁ
...
browsing-card-state = ପତ୍ର ଅବସ୍ଥା
...
browsing-change-to = { $val }କୁ ଏଥିରେ ପରିବର୍ତ୍ତନ କରନ୍ତୁ:
...
browsing-please-select-cards-from-only-one = ଦୟାକରି କେବଳ ଗୋଟିଏ ନୋଟ୍ ପ୍ରକାରର ପତ୍ରଗୁଡ଼ିକ ଚୟନ କରନ୍ତୁ।
