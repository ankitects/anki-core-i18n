card-stats-added = Dodana
card-stats-first-review = Prvo ponavljanje
card-stats-latest-review = Posljednje ponavljanje
...
card-stats-total-time = Ukupno vrijeme
card-stats-new-card-position = Pozicija
card-stats-card-template = Vrsta kartice
card-stats-note-type = Vrsta bilješke
card-stats-deck-name = Špil
card-stats-preset = Predložak
...
card-stats-current-card = Trenutna kartica ({ $context })
card-stats-previous-card = Prethodna kartica ({ $context })

## NO NEED TO TRANSLATE. This text is no longer used by Anki, and will be removed in the future.

card-stats-fsrs-forgetting-curve-probability-of-recalling = Vjerojatnost Prisjećanja
