...
scheduling-easy-bonus = Laki bonus
scheduling-easy-interval = Laki interval
scheduling-general = Općenito
scheduling-graduating-interval = Interval za prijelaz na viši stupanj
...
scheduling-new-cardsday = Novih karata po danu
scheduling-new-interval = Novi razmak
...
scheduling-show-answer-timer = Prikaži vrijeme odgovaranja
