...
browsing-any-flag = Bilo koja oznaka
browsing-average-ease = Prosječna lakoća
...
browsing-flag = Oznaka
browsing-font = <b>Font</b>:
browsing-font-size = <b>Veličina Fonta</b>:
...
browsing-last-card = Zadnja karta
...
browsing-please-give-your-filter-a-name = Molimo vas dajte naziv svom filteru:
...
browsing-replace-with = <b>Zamijeni sa</b>:
...
browsing-shift-position-of-existing-cards = Promijeni položaj postojećih karata
...
browsing-sort-field = Sortiranje polja
browsing-sorting-on-this-column-is-not = Sortiranje prema ovom stupcu nije podržano. Odaberite drugo.
browsing-start-position = Početni položaj:
browsing-step = Korak:
browsing-suspended = Suspendirano
browsing-tag-duplicates = Duplikati oznaka
browsing-tag-rename-warning-empty = Ne možete preimenovati oznaku koja nema bilješki.
browsing-target-field = Ciljno polje:
browsing-toggle-bury = Uključi/isključi sakrivanje
browsing-toggle-showing-cards-notes = Uključi/isključi kartice/bilješke
browsing-toggle-mark = Uključi/isključi oznaku
browsing-toggle-suspend = Uključi/isključi obustavu
browsing-treat-input-as-regular-expression = Tretira unos kao regularni izraz
browsing-update-saved-search = Ažuriraj s trenutnim pretragom
browsing-whole-collection = Cijeli komplet
browsing-window-title-notes = Pregledaj ({ $selected } od { $total } bilješka)
