...
card-templates-sample-cloze = Ovo je { "{{c1::" }primjer{ "}}" } nadopunjavanja.
...
card-templates-extraneous-cloze = 'cloze:' se može koristiti samo na karticama na nadopunjavanje.
