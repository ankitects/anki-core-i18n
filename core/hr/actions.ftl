...
actions-discard = Odbaci
actions-copy = Kopiraj
actions-create-copy = Stvori kopiju
actions-custom-study = Prilagođena studija
actions-decks = Špilovi
actions-decrement-value = Smanjenje vrijednosti
actions-delete = Obriši
actions-export = Izvezi
actions-empty-cards = Prazne kartice
actions-filter = Filter
actions-help = Pomoć
actions-increment-value = Povećavanje vrijednosti
actions-import = Uvezi
actions-manage = Upravljati...
actions-name = Naziv:
actions-new = Novo
...
actions-rename-tag = Preimenuj oznaku
actions-rename-with-parents = Preimenuj s nadređenima
actions-remove-tag = Ukloni oznaku
...
actions-set-due-date = Postavite datum dospijeća
...
actions-unbury-unsuspend = Odkopaj/Odustani od suspenzije
actions-add-deck = Dodaj špil
actions-add-note = Dodaj bilješku
actions-update-tag = Ažuriraj oznaku
actions-update-note = Ažuriraj bilješku
actions-update-card = Ažuriraj karticu
actions-update-deck = Ažurirajte špil
actions-forget-card = Ponovno postavite karticu
actions-build-filtered-deck = Napravite špil
actions-add-notetype = Dodaj vrstu bilješke
actions-remove-notetype = Ukloni vrstu bilješke
actions-update-notetype = Ažurirajte vrstu bilješke
actions-update-config = Ažuriranje konfiguracije
actions-card-info = Informacije o kartici
actions-previous-card-info = Informacije o prethodnoj kartici
# By convention, the name of a menu action is suffixed with "..." if additional
# input is required before it can be performed. E.g. "Export..." vs. "Delete".
actions-with-ellipsis = { $action }...
actions-fullscreen-unsupported = Način rada preko cijelog zaslona nije podržan za vaš upravljački program za video. Pokušajte prebaciti se na drugi način s zaslona postavki.
actions-flag-number = Označi { $number }
...
actions-flag-red = Crveno
actions-flag-orange = Narančasto
actions-flag-green = Zeleno
actions-flag-blue = Plavo
actions-flag-pink = Ružičasta
actions-flag-turquoise = Tirkiz
actions-flag-purple = Ljubičasta

##

actions-set-flag = Postavi oznaku
actions-nothing-to-undo = Ništa za poništiti
