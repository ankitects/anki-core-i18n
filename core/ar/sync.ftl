...
sync-conflict-explanation =
    ...
    إذا اخترت تنزيل، أنكي سينزل المجموعة من أنكي ويب، وستفقد أي تغييرات أجريتها على هذا الحاسوب منذ آخر مزامنة.
    
    إذا اخترت رفع، أنكي سيرفع مجموعتك إلى أنكي ويب، وستفقد أي تغييرات أجريتها في أنكي ويب أو أجهزتك الأخرى منذ آخر مزامنة إلى هذا الجهاز.
