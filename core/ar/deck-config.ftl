...
deck-config-new-card-sort-order-tooltip-2 =
    `قالب البطاقة`:  يعرض البطاقات بترتيب قوالب البطاقات. إذا كان دفن الأشقاء غير مفعل،
    ...
    `قالب البطاقة، ثم عشوائي`: مثل `قالب البطاقة`، لكنه يخلط بطاقات كل قالب.
    عندما يتم جمع هذا الخيار مع ترتيب جلب حسب المواضع المتصاعدة، يمكن استخدامه
    لإظهار البطاقات الأقدم بترتيب عشوائي مثلًا.
    
    `فرز الملحوظات عشوائيًا، ثم قالب البطاقة`: يختار الملحوظات عشوائيًا، ثم يظهر كل بطاقاتها
    بالترتيب.
...
deck-config-sort-order-random-note-then-template = فرز الملحوظات عشوائيًا، ثم قالب البطاقة
