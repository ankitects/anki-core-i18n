...
browsing-place-at-end-of-new-card = ضع في آخر صف البطاقات الجديدة
browsing-place-in-review-queue-with-interval = ضع في صف المراجعات بفاصل زمني بين:
...
browsing-sidebar-recent = مؤخرًا
browsing-sidebar-due-today = مستحقة اليوم
browsing-sidebar-due-tomorrow = مستحقة غدًا
