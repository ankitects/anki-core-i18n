...
browsing-find-duplicates = Sök dubbletter
browsing-first-card = Första kortet
browsing-flag = Märk
...
browsing-please-give-your-filter-a-name = Var god ge ditt filter ett namn:
...
browsing-step = Steg:
browsing-suspended = Låst
browsing-tag-duplicates = Etikettera dubbletter
...
browsing-toggle-suspend = Växla låst
...
browsing-sidebar-expand-children = Visa underordnade
browsing-sidebar-collapse-children = Dölj underordnade
