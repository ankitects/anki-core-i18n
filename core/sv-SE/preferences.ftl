...
preferences-media-is-not-backed-up = Media har ej säkerhetskopierats. Var god skapa periodvis säkerhetskopior av Anki-mappen för att vara säker.
...
preferences-minutes-between-backups = Minuter mellan automatisk säkerhetskopiering:
