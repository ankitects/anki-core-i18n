...
adding-note-deleted = (Notă ștearsă)
adding-shortcut = Surtătură:
adding-the-first-field-is-empty = Primul câmp este gol.
adding-you-have-a-cloze-deletion-note = Aveți o notă de tip „cloze”, dar nu ați făcut nicio selecție cloze. Continuați?
adding-cloze-outside-cloze-notetype = Ascunderea conținutului poate fi folosită numai la note de tip „cloze”.
