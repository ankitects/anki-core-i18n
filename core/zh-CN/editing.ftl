...
editing-cloze-deletion = 完形填空（新增卡片）
editing-cloze-deletion-repeat = 设置完形填空（相同卡片）
...
editing-to-make-a-cloze-deletion-on = 若要在现有笔记上设置完形填空，请通过「笔记」>「更改笔记模板」将笔记模板修改为填空题笔记模板。
...
editing-warning-cloze-deletions-will-not-work = 警告，在您将笔记模板修改为填空题笔记模板前，您设置的空格不会生效。
