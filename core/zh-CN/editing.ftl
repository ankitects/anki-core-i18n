...
editing-cloze-deletion = 设置空格（新空格序号）
editing-cloze-deletion-repeat = 设置空格（同空格序号）
...
editing-to-make-a-cloze-deletion-on = 若要在现有笔记上设置空格，请通过「笔记」>「更改笔记模板」将笔记模板修改为填空题笔记模板。
