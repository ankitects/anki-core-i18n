...
adding-you-have-a-cloze-deletion-note = 您选择的是填空题笔记模板，但尚未设置完形填空。是否继续？
adding-cloze-outside-cloze-notetype = 仅填空题笔记模板可以设置完形填空。
adding-cloze-outside-cloze-field = 仅含有「cloze:」筛选器的字段可以设置完形填空。一般是首字段。
