...
notetypes-create-scalable-images-with-dvisvgm = 使用dvisvgm创建可缩放的图片
notetypes-delete-this-note-type-and-all = 删除该笔记类型及其所有卡片?
notetypes-delete-this-unused-note-type = 删除该未使用的笔记类型?
notetypes-fields = 字段
notetypes-footer = 底部
notetypes-header = 头部
notetypes-note-types = 笔记类型
notetypes-options = 选项
notetypes-please-add-another-note-type-first = 请先添加另一个笔记类型。
notetypes-type = 类型
