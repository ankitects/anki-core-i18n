...
card-templates-invalid-template-number = 卡片类型{ $number }有问题
...
card-templates-add-card-type = 添加卡片类型…
card-templates-anki-couldnt-find-the-line-between = Anki无法区分问题与答案。请手动调整模版以明确问题与答案。
card-templates-at-least-one-card-type-is = 至少保留一种卡片类型
...
card-templates-delete-the-as-card-type-and = 确定删除“{ $template }”卡片类型及其{ $cards }吗？
...
card-templates-reposition-card-type = 调整卡片类型顺序…
