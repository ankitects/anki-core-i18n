...
decks-build = Criar
decks-cards-selected-by = cartas selecionadas por
...
decks-repeat-failed-cards-after = Repita as cartas com falha depois
decks-reschedule-cards-based-on-my-answers = Reagendar cartas baseado nas minhas respostas neste baralho
decks-study = Estudar
decks-study-deck = Estudar baralho
decks-filtered-deck-search-empty = Nenhuma carta correspondeu à pesquisa fornecida. Algumas cartas podem ter sido excluídas porque estão em um baralho filtrado diferente ou suspensas.
decks-unmovable-cards = Mostrar todos as cartas excluídas
