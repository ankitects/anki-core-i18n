...
card-templates-invalid-template-number = O modelo da carta { $number } tem um problema.
card-templates-identical-front = O lado frontal é idêntico ao modelo da carta { $number }.
card-templates-no-front-field = Esperado encontrar um substituto de campo na frente do modelo da carta.
...
card-templates-add-card-type = Adicionar Tipo de Carta...
...
card-templates-at-least-one-card-type-is = Pelo ao menos um tipo de carta é requerido.
card-templates-browser-appearance = Aparência do Navegador...
card-templates-card = Carta { $val }
card-templates-card-types = Tipos de Carta
card-templates-card-types-for = Tipos de Carta para { $val }
card-templates-cloze = Omissão de Palavras { $val }
card-templates-deck-override = Substituição de Baralho...
card-templates-delete-the-as-card-type-and = Apagar o '{ $template }' tipos de carta, e os { $cards }?
card-templates-enter-deck-to-place-new = Abra o baralho para colocar { $val } novas cartas nele ou deixe em branco:
card-templates-enter-new-card-position-1 = Digite a nova posição da carta (1...{ $val }):
card-templates-flip = Virar
card-templates-form = Formulário
card-templates-off = (desligado)
card-templates-on = (ligado)
card-templates-remove-card-type = Remover Tipo de Carta...
card-templates-rename-card-type = Renomear Tipo de Carta...
card-templates-reposition-card-type = Reposicionar Tipo de Carta...
...
card-templates-this-will-create-card-proceed =
    { $count ->
        [one] Isto criará { $count } carta. Continuar?
       *[other] Isto criará { $count } cartas. Continuar?
    }
