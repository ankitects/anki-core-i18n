preferences-anki-21-scheduler-beta = Agendador do Anki 2.1 (beta)
...
preferences-hardware-acceleration-faster-may-cause-display = Aceleração por Hardware (mais rápido, porém pode causar problemas de exibição)
...
preferences-you-can-restore-backups-via-fileswitch = Você pode restaurar cópias de seguranças em Arquivo>Mudar Perfil.
