...
preferences-show-learning-cards-with-larger-steps = Exibir as cartas de aprendizagem com intervalos maiores antes de efetuar novas revisões
preferences-show-next-review-time-above-answer = Mostrar tempo da próxima revisão acima dos botões de resposta
preferences-show-play-buttons-on-cards-with = Mostrar botões de reprodução nas cartas com áudio
preferences-show-remaining-card-count-during-review = Mostrar contador de cartas restantes durante a revisão
