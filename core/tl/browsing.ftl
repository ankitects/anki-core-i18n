...
browsing-ease = Dali
browsing-enter-tags-to-add = Ilagay ang mga idadagdag na tag:
browsing-enter-tags-to-delete = Ilagay ang mga idi-delete na tag:
...
browsing-font-size = <b>Laki ng Font</b>:
browsing-found-as-across-bs = Nahanap ang { $part } sa { $whole }.
browsing-ignore-case = Huwag pansinin ang case
browsing-in = <b>Nasa</b>:
...
browsing-new = (bago)
browsing-new-note-type = Bagong note type:
browsing-no-flag = Walang Flag
