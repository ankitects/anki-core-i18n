...
card-stats-review-log-rating = Novērtējums
card-stats-review-log-type = Veids
card-stats-review-log-date = Datums
card-stats-review-log-time-taken = Laiks
card-stats-review-log-type-learn = Apgūt
card-stats-review-log-type-review = Pārskatīt
card-stats-review-log-type-relearn = Apgūt no jauna
card-stats-review-log-type-filtered = Atlasītās
card-stats-review-log-type-manual = Pašrocīgi
card-stats-review-log-type-rescheduled = Pārplānotās
card-stats-review-log-elapsed-time = Patērētais laiks
card-stats-no-card = (Nav kartīšu, ko parādīt.)
card-stats-custom-data = Pielāgoti dati
card-stats-fsrs-stability = Noturība
card-stats-fsrs-difficulty = Grūtība
card-stats-fsrs-retrievability = Atgūstamība
card-stats-fsrs-forgetting-curve-title = Aizmiršanas līkne
