...
actions-options-for = Opcijas { $val }
...
actions-update-card = Atjaunināt kārti
actions-update-deck = Atjaunināt kavu
actions-forget-card = Atiestatīt kārti
