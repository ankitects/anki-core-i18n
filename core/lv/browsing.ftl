...
browsing-card = Kārts
browsing-cards = Kārtis
browsing-card-list = Karšu saraksts
browsing-cards-cant-be-manually-moved-into = Kārtis nevar manuāli tikt pārvietuotas filtrētā kavā.
browsing-cards-deleted =
    { $count ->
        [zero] Nav neviena kārts dzēsta.
        [one] { $count } kārts dzēsta.
       *[other] { $count } kārtis dzēstas.
    }
...
browsing-current-note-type = Pašreizējais piezīmes tips:
...
browsing-first-card = Pirmā kārts
...
browsing-preview-selected-card = Priekšskatīt atlasītuo kārti ({ $val })
...
browsing-reposition-new-cards = Pārvietuot jaunās kārtis
browsing-reschedule = Pārplānuot
browsing-search-bar-hint = Meklēt kārtis/piezīmes (ierakstīet tekstu, tad spiediet uz Enter)
...
browsing-changed-new-position =
    { $count ->
        [zero] Nav mainīta pozīcija nevienai jaunai kārtij.
        [one] Mainīta pozīcija { $count } kārtij.
       *[other] Mainīta pozīcija { $count } kārtīm.
    }
