...
card-templates-add-card-type = Pievienuot kārts tipu.
card-templates-anki-couldnt-find-the-line-between = Anki nespēja atrast līniju starp jautājumu un atbildi. Lūdzu, pielāgojiet veidni manuāli lai pārslēgtu jautājumu un atbildi.
card-templates-at-least-one-card-type-is = Ir nepieciešams vismaz viens kārts tips.
card-templates-browser-appearance = Pārlūka izskats...
card-templates-card = Kārts { $val }
card-templates-card-types-for = Kārts tips priekš { $val }
