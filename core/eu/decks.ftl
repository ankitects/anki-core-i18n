...
decks-filter-2 = Iragazki 2
decks-get-shared = partekatuta lortu
decks-import-file = Inportatu fitxategia
decks-increasing-intervals = tarteak handitik
decks-latest-added-first = lehengoan gehituta azkena
...
decks-order-added = oraintsu ikusitakoak lehenik
decks-order-due = epemuga hurrenkera
decks-please-select-something = Mesedez zerbait aukera ezazu
decks-random = Ausazkoa
decks-relative-overdueness = epemuga gainditutari erlatiboa
