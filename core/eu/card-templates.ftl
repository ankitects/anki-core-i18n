...
card-templates-add-card-type = Gehitu txartel-mota...
...
card-templates-at-least-one-card-type-is = Txartel-mota bat behar da gutxienez.
card-templates-browser-appearance = Arakatzaileko itxura...
card-templates-card = { $val }. txartela
