...
deck-config-bury-priority-tooltip =
    ...
    - 啟用所有暫停選項時，將會顯示順序最前的關聯卡片。例如，複習卡會優先於新卡片顯示。
    - 順序靠後的關聯卡片無法暫停順序較前的卡片類型。例如，停用「暫停關聯的新卡片」時，學習新卡片後隔天學習卡片和複習卡不會被暫停，因此關聯的複習卡和新卡片可能會同時出現。
...
deck-config-new-gather-priority-tooltip-2 =
    `牌組順序`：依牌組順序，由上至下收集卡片。依照遞增順序收集各個牌組中的卡片。若選取的牌組已達每日上限，收集卡片時可能不會檢查到部分牌組。在較大的集合中，此選項的速度最快，並讓你能夠優先學習順序靠上的下層牌組。
