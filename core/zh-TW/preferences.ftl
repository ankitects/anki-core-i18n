...
preferences-synchronizationnot-currently-enabled-click-the-sync = <b>同步</b><br> 尚未啟用；請按一下主視窗中的「同步」按鈕來啟用。
...
preferences-weekly-backups = 保留備份數量（每週）：
preferences-monthly-backups = 保留備份數量（每月）：
