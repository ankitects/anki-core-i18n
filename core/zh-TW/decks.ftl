...
decks_create_even_if_empty = 空白時仍建立/更新此牌組
...
decks-filtered-deck-search-empty = 沒有卡片符合提供的搜尋條件。有些卡片可能因為已被放入其他篩選牌組或已擱置而被排除。
decks-choose-deck = 選擇牌組
decks-target-deck-ctrlandd = 目標牌組 (Ctrl+D)

## Sort order of cards

# Combobox entry: Sort the cards by the date they were added, in ascending order (oldest to newest)
decks-order-added = 新增順序
