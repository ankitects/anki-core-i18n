...
preferences-generate-latex-images-automatically = Генерувати зображення LaTeX (небезпечно)
preferences-latex-generation-disabled = Генерацію зображень LaTeX вимкнено в налаштуваннях.
...
preferences-show-remaining-card-count = Показувати лічильник залишку карток
...
preferences-minimalist-mode-tooltip = Компактніший/менш вишуканий інтерфейс
