...
preferences-generate-latex-images-automatically = Створення зображень LaTeX (ризик для безпеки)
preferences-latex-generation-disabled = Створення зображень LaTeX вимкнено в налаштуваннях.
...
preferences-not-logged-in = Зараз не ввійшли в AnkiWeb.
preferences-login-successful-sync-now = Вхід успішний. Зберегти налаштування та синхронізувати зараз?
...
preferences-minimalist-mode-tooltip = Зробіть інтерфейс більш компактним/менш вигадливим
