...
importing-include-reviews-help =
    ...
    Інакше всі картки буде імпортовано як нові, а будь-які позначки і¶
    теги будуть видалені.
importing-with-deck-configs-help =
    Якщо ввімкнути, будь-які параметри налаштування колоди також будуть імпортовані.¶
    В іншому випадку для всіх колод буде призначено стандартне налаштування.
...
importing-update-notes-help =
    Коли оновлювати наявну нотатку у вашій колекції. За замовчуванням це робиться лише¶
    якщо відповідну імпортовану нотатку було нещодавно змінено.
importing-update-notetypes = Оновити типи нотаток
importing-update-notetypes-help =
    Коли оновлювати наявний тип нотаток у вашій колекції. За замовчуванням це робиться лише¶
    якщо відповідний імпортований тип нотаток було нещодавно змінено. Зміни в тексті шаблону¶
    і стиль імпортуватимуться, але для змін схеми (наприклад, якщо кількість або порядок¶
    полів змінено), також потрібно буде ввімкнути опцію '{ importing-merge-notetypes }'.
importing-note-added =
    { $count ->
        [one] { $count } нотатку додано
        [few] { $count } нотаток додано
       *[other] { $count } нотаток додано
    }
importing-note-imported =
    { $count ->
        [one] { $count } нотатку імпортовано.
        [few] { $count } нотатки імпортовано.
       *[other] { $count } нотаток імпортовано.
    }
importing-note-unchanged =
    { $count ->
        [one] { $count } нотатка без змін
        [few] { $count } нотатки без змін
...
importing-failed-to-import-media-file = Не вдалося імпортувати медіафайл: { $debugInfo }
...
importing-cards-added =
    { $count ->
        [one] { $count } картку додано.
        [few] { $count } картки додано.
       *[many] { $count } карток додано.
    }
importing-file-empty = Вибраний файл порожній.
importing-notes-added =
    { $count ->
        [one] { $count } нову нотатку імпортовано.
        [few] { $count } нові нотатки імпортовано.
       *[many] { $count } нових нотаток імпортовано.
    }
importing-notes-updated =
    { $count ->
        [one] { $count } примітку було використано для оновлення наявних.
        [few] { $count } примітки було використано для оновлення наявних.
       *[many] { $count } приміток було використано для оновлення наявних.
    }
importing-existing-notes-skipped =
    { $count ->
        [one] { $count } нотатка уже є у вашій колекції.
        [few] { $count } нотатки уже є у вашій колекції.
       *[many] { $count } нотаток уже є у вашій колекції.
    }
importing-notes-failed =
    { $count ->
        [one] { $count } нотатку не може бути імпортовано.
        [few] { $count } нотаток не може бути імпортовано.
       *[many] { $count } нотаток не може бути імпортовано.
    }
...
importing-field-separator-help =
    Поля символів розділення у текстовому файлі. Ви можете використовувати попередній перегляд, щоб перевірити¶
    чи поля розділені правильно.¶
    ¶
    Зауважте, якщо цей символ з’являється в будь-якому полі, це поле має¶
    розцінюватись як відповідаюче стандарту CSV. Програми для роботи з електронними таблицями, наприклад LibreOffice, можуть¶
    зробити це автоматично.
importing-allow-html-in-fields-help =
    Увімкніть це, якщо файл містить форматування HTML. Наприклад якщо файл містить рядок¶
    '&lt;br&gt;', це відображатиметься як розрив рядка на картці. Але якщо¶
    параметр вимкнено, будуть відображені тільки літеральні символи '&lt;br&gt;' .
importing-notetype-help =
    Щойно імпортовані нотатки матимуть цей тип, і лише існуючі нотатки з таким¶
    типом буде оновлено.¶
    ¶
    Ви можете вибрати, які поля у файлі відповідають полям типу нотаток за допомогою¶
    інструменту картографування.
importing-deck-help = Імпортовані карти будуть розміщені в цій колоді.
...
importing-match-scope-help =
    Лише наявні нотатки з тим самим типом перевірятимуться на наявність дублікатів. Це може¶
    бути додатково обмежено для нотаток з картами в тій самій колоді.
importing-tag-all-notes-help = Ці теги буде додано як до нещодавно імпортованих, так і до оновлених нотаток.
importing-tag-updated-notes-help = Ці теги буде додано до будь-яких оновлених нотаток.
