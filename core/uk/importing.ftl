...
importing-notes-added-from-file = Записи додані з файлу: { $val }
importing-notes-found-in-file = Записи знайдені в файлі: { $val }
importing-notes-skipped-as-theyre-already-in = Записи пропущено, оскільки вже є в колекції: { $val }
importing-notes-that-could-not-be-imported = Записи не імпортовано через зміну їх типу: { $val }
...
importing-tag-modified-notes = Додати примітку зміненим записам:
