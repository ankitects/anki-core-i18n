...
deck-config-compute-optimal-weights-tooltip2 =
    Після натиснення кнопки «Оптимізувати», ВПРП проаналізує історію пригадувань та згенерує оптимальні параметри для
    запам'ятовування та матеріалу, який вивчаєте. Якщо ваші колоди суттєво відрізняються своєю складністю,
    радимо створити для них різні конфігурації, адже параметри для легких та складних колод відрізнятимуться.
