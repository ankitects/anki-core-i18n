...
deck-config-compute-minimum-recommended-retention = Найменше рекомендоване пригадування
...
deck-config-predicted-minimum-recommended-retention = Найменше рекомендоване пригадування: { $num }
...
deck-config-historical-retention-tooltip =
    ...
    він припускає, що у старих пригадуваннях запам'яталось 90% матеріалу. Якщо старі запам'ятовування
...
deck-config-weights-tooltip2 =
    Параметри FSRS впливають на планування для карток. Anki запуститься з параметрами за замовчуванням. Ви можете використовувати ¶
    опцію нижче, щоб оптимізувати параметри таким чином, що найкраще відповідає вашій продуктивності в колодах, використовуючи цей пресет
...
deck-config-reschedule-cards-warning =
    Залежно від бажаної  затримки, це може призвести до появи великої кількості карток¶
    тому не рекомендується під час першого переходу з SM2.¶ ¶Використовуйте цю опцію обережно, оскільки вона додасть запис відгуку до кожної вашої картки, і¶
    збільшить розмір вашої колекції.
deck-config-ignore-before-tooltip =
    Якщо встановлено, перевірки до вказаної дати ігноруватимуться під час оптимізації та оцінки параметрів FSRS.¶
    Це може бути корисним, якщо ви імпортували чужі дані планування або змінили спосіб використання кнопок відповіді.
...
deck-config-compute-optimal-retention-tooltip3 =
    ...
    яке дозволить засвоїти найбільшу кількість матеріалу за найменший час. Щоб точно імітувати процес навчання, ¶
    ця функція вимагає мінімум 400+ переглядів. Розраховане число може бути орієнтиром, коли ви вирішуєте яке ¶
    значення встановити для затримки. Можливо, ви захочете вибрати вище значення затримки, якщо бажаєте витрачати більше часу на навчання ¶
    для збільшення швидкості запам'ятовування. Не рекомендується встановлювати затримку нижче мінімуму, оскільки це ¶
    призведе до надмірного навантаження та збільшить рівень забування.
