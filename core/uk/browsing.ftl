...
browsing-addon = Додаток
browsing-again-today = Повторити сьогодні
browsing-all-card-types = Усі типи карток
browsing-all-fields = Всі поля
browsing-answer = Відповідь
browsing-any-cards-mapped-to-nothing-will = Картки, у яких нема відповідників, будуть видалені. Якщо нотатка більше не містить карток, вона буде втрачена. Ви впевнені, що хочете продовжити?
...
browsing-card-state = Стан картки
...
browsing-change-to = Змінити { $val } на:
browsing-clear-unused = Прибрати невикоритане
browsing-clear-unused-tags = Очистити невикористані теґи
browsing-created = Створено
browsing-ctrlandshiftande = Ctrl+Shift+E [латинське]
...
browsing-delete-tags = Видалити мітки
...
browsing-notes-tagged = Нотатки з мітками.
browsing-nothing = Нічого
browsing-only-new-cards-can-be-repositioned = Можна змінити черговість лише нових карток.
...
browsing-override-front-template = Ігнорувати шаблон лицьової сторони:
browsing-place-at-end-of-new-card = Помістити в кінець черги нових карток
browsing-place-in-review-queue-with-interval = Помістити у чергу карток на повтор з інтервалом між:
browsing-please-give-your-filter-a-name = Будь ласка, назвіть свій фільтр:
browsing-please-select-cards-from-only-one = Виберіть картки лише одного типу нотаток.
...
browsing-remove-current-filter = Приберання поточного фільтру…
browsing-remove-from-your-saved-searches = Прибрати { $val } із збережених пошуків?
browsing-remove-tags = Видалення приміток…
...
browsing-save-current-filter = Збереження поточного фільтру…
