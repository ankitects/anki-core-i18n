...
sync-conflict-explanation2 =
    Існує конфлікт між колодами на цьому пристрої та AnkiWeb. Ви повинні вибрати, яку версію зберегти:¶
    ¶
    - Виберіть **{ sync-download-from-ankiweb }**, щоб замінити колоди тут версією AnkiWeb. Ви втратите всі зміни, внесені на цьому пристрої після останньої синхронізації.¶
    - Виберіть **{ sync-upload-to-ankiweb }**, щоб перезаписати версії AnkiWeb колодами з цього пристрою та видалити будь-які зміни в AnkiWeb.¶
    ¶
    Після вирішення конфлікту синхронізація працюватиме як зазвичай.
