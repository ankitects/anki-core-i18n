...
scheduling-bury-related-new-cards-until-the = Поховати пов'язані нові картки до наступного дня
scheduling-bury-related-reviews-until-the-next = Поховати пов'язані картки на повторення до наступного дня
...
scheduling-parent-limit = (ліміт колоди вищого порядку: { $val })
