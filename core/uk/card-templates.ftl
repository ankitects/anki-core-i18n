card-templates-changes-will-affect-notes =
    { $count ->
        [one] Наступні зміни вплинуть на { $count } запис, який використовує цей тип картки.
        [few] Наступні зміни вплинуть на { $count } записи, які використовують цей тип картки.
       *[other] Наступні зміни вплинуть на { $count } записів, які використовують цей тип картки.
    }
...
card-templates-delete-the-as-card-type-and = Видалити тип картки '%(a)s', та її %(b)s?
