...
notetypes-no-occlusion-created = Ви повинні зробити принаймні одне скриття
notetypes-no-occlusion-created2 = Не вдалося додати. Або ви не додали жодного скриття, або перше поле порожнє.
