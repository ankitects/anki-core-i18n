...
exporting-include = <b>Incluír</b>:
exporting-include-html-and-media-references = Incluír HTML e referencias multimedia
exporting-include-media = Incluír os ficheiros multimedia
...
exporting-include-deck = Incluír nome da baralla
exporting-include-notetype = Incluír nome do tipo de nota
exporting-include-guid = Incluír identificador único
