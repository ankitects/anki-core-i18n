...
statistics-today-no-mature-cards = Hoxe non se estudaron tarxetas antigas.
statistics-today-correct-mature = Respostas correctas en tarxetas antigas: { $correct }/{ $total } ({ $percent }%)
...
statistics-axis-label-card-count = Tarxetas
statistics-axis-label-review-time = Tempo do repaso
