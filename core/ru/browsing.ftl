...
browsing-change-notetype = Изменить тип заметок
...
browsing-sort-field = Сортировать поле
...
browsing-toggle-showing-cards-notes = Не показывать карточки/записи
browsing-toggle-mark = Снять отметку
browsing-toggle-suspend = Активировать
