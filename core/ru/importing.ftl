...
importing-merge-notetypes = Объединить типы записей
importing-merge-notetypes-help =
    Если включено и вы или автор колоды изменили тип записи, то Anki объединит эти версии вместо того, чтобы оставить обе.
    
    Изменение типа записи означает добавление, удаление или переупорядочивание полей и шаблонов или изменение поля сортировки.
    С другой стороны, изменение лицевой стороны шаблона *не* представляет собой изменение типа.
    
    Предупреждение: потребуется односторонняя синхронизация, и существующие записи могут быть отмечены как изменённые.
...
importing-include-reviews-help =
    Если включено, то будут импортированы сведения о предыдущих повторениях, добавленные автором колоды.
     В противном случае все карточки будут импортированы как новые, а с отмеченных и приставучих будут сняты метки.
importing-with-deck-configs-help =
    Если включено, то будут импортированы все парамерты колоды, указанные автором.
     В противном случае всем колоде будет назначена конфигурация по умолчанию.
...
importing-update-notes-help = Когда следует обновлять существующие записи в вашей коллекции. По умолчанию это происходит, только если соответствующая импортируемая запись новее.
