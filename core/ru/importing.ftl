...
importing-merge-notetypes-help =
    Если этот флажок установлен, и вы или автор колоды изменили схему типа заметки, Anki объединит две версии вместо того, чтобы сохранить обе.
    ...
    В качестве контрпримера, изменение лицевой стороны существующего шаблона *не* представляет собой изменение схемы.
