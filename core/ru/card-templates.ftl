...
card-templates-identical-front = Лицо совпадает с шаблоном карточки { $number }.
card-templates-no-front-field = В шаблоне на лице карточки ожидается замена поля.
