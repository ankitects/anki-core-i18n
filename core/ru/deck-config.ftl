...
deck-config-ignore-before = Игнорировать повторения до
...
deck-config-fsrs-on-all-clients =
    Пожалуйста, убедитесь, что вы обновили Anki(Mobile) до версии 23.10+ или AnkiDroid до версии 2.17+. 
...
deck-config-historical-retention-tooltip =
    ...
    1. Вы использовали опцию "игнорировать повторения до".
