custom-study-must-rename-deck = Спачатку пераймянуйце існуючую калоду дапасаванага навучання.
...
custom-study-custom-study-session = Сэсія дапасаванага навучання
custom-study-due-cards-only = Толькі карткі на сёння
custom-study-increase-todays-new-card-limit = Павялічыць сённяшні ліміт новых картак
...
custom-study-preview-new-cards-added-in-the = Перадпрагляд новых картак, дададзеных у апошнія
custom-study-require-one-or-more-of-these = Неабходны як мінімум адзін з гэтых цэтлікаў:
custom-study-review-ahead = Пераглядзець датэрмінова
