...
fields-font = Shrift:
fields-new-position-1 = Yangi oʻrni (1...{ $val }):
...
fields-collapse-by-default = Birlamchi boʻyicha yigʻish
fields-html-by-default = Birlamchi boʻyicha HTML muharririni ishlatish
fields-size = Oʻlcham:
fields-sort-by-this-field-in-the = Karta brauzerida bu maydon boʻyicha saralash
