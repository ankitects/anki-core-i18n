...
preferences-spacebar-rates-card = La touche espace (ou entrée) permet aussi de répondre aux cartes
preferences-show-play-buttons-on-cards-with = Afficher les boutons de lecture sur les cartes avec de l’audio
preferences-show-remaining-card-count = Afficher le nombre de cartes restantes
...
preferences-always = Toujours
preferences-full-screen-only = Plein écran seulement
preferences-appearance = Apparence
preferences-general = Général
preferences-style = Style
preferences-review = Révision
...
preferences-account = Compte AnkiWeb
preferences-note = Note
preferences-scheduler = Planificateur
