importing-failed = Échec de l’importation.
...
importing-map-to-tags = Associer aux marqueurs
importing-mapped-to = associé à <b>{ $val }</b>
importing-mapped-to-tags = associé à <b>Marqueurs</b>
...
importing-rows-had-num1d-fields-expected-num2d = « %(row)s » avait %(num1)d champs au lieu des %(num2)d prévus
