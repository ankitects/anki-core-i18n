...
browsing-place-at-end-of-new-card = Placer à la fin de la file d’attente des nouvelles cartes.
browsing-place-in-review-queue-with-interval = Placer en attente de révisions, au rythme d’un intervalle entre :
...
browsing-remove-current-filter = Supprimer le filtre actuel...
browsing-remove-from-your-saved-searches = Retirer { $val } de vos recherches enregistrées ?
...
browsing-save-current-filter = Enregistrer le filtre actuel...
