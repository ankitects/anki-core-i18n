...
studying-deleting-this-deck-from-the-deck = Forigo de ĉi tiu kartaro el la kartaro-listo remetos ĉiujn restantajn kartojn al siaj originalaj kartaroj.
...
studying-it-has-been-suspended = Ĝi estis paŭzigita.
...
studying-note-suspended = Noto estas paŭzigita.
...
studying-suspend = paŭzigi
studying-suspend-note = paŭzigi noton
