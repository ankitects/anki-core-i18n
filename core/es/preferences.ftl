preferences-anki-21-scheduler-beta = Programador de Anki 2.1 (beta)
...
preferences-hardware-acceleration-faster-may-cause-display = Aceleración por hardware (rápido, pero puede causar problemas de visualización)
...
preferences-this-will-reset-any-cards-in = Esto reseteará cualquier tarjeta en aprendizaje, vaciará los mazos filtrados, y cambiará la versión del planificador. ¿Deseas proceder?
