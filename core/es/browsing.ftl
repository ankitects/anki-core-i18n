...
browsing-add-to-selected-notes = Agregar a las notas seleccionadas
...
browsing-cards-deleted-with-deckname =
    { $count ->
        [one] { $count } carta eliminada de { $deck_name }
       *[other] { $count } cartas eliminadas de { $deck_name }
    }
...
browsing-clear-unused-tags = Limpiar tags no usados
...
browsing-please-give-your-filter-a-name = Por favor, de un nombre al filtro:
...
browsing-sorting-on-this-column-is-not = No es posible cambiar el orden en esta columna. Por favor, elige otra.
...
browsing-treat-input-as-regular-expression = Tratar inserción como expresión regular
...
browsing-cards-updated =
    { $count ->
       ...
       *[other] { $count } tarjetas actualizada.
    }
...
browsing-sidebar-flags = Banderas
browsing-today = Hoy
