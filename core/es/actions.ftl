...
actions-fullscreen-unsupported = Modo de pantalla complete no es compatable con tu controlador de vídeo. Intente cambiar a uno diferente desde la pantalla de preferencias.
