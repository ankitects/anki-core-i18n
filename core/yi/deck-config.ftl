...
deck-config-learning-steps-tooltip =
    ...
    דאָס ׳גוט׳ קנעפּל וועט גיין פֿאָרויס צום קומעדיקן טראָט, וואָס איז 10 מינוטן דורך פֿעליקייט.
    ווי נאָר אַלע טריט זענען פֿאַרבײַ, דאָס קאַרטל ווערט אַן איבער׳חזר-קאַרטל, און וועט ווערן באַוויזן אַן אַנדערן טאָג. { -deck-config-delay-hint }
deck-config-graduating-interval-tooltip = וויפֿל טעג אויף צו וואַרטן ביז אַ קאַרטל באַווײַזט זיך ווידער, ווי נאָר דאָס ׳גוט׳ קנעפּל ווערט געקוועטשט אונעם לעצטן לערנטראָט.
