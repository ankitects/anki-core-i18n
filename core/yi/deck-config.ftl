...
deck-config-interval-modifier-tooltip = אָט דער כּפֿלער ווערט כּפֿלעט אויף אַלע איבער׳חזר׳ונגען, און מע קען ניצן קליינע צופּאַסונגען כּדי צו מאַכן „אַנקי״ מער קאָנסערוואַטיוו אָדער אַגרעסיוו מיטן פּלאַנירן. ביטע גיט אַ קוק איבער דאָס האַנטביכל פֿאַרן בײַטן די ברירה.
