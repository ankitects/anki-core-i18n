...
search-empty-group = אַ גרופּע `(...)` געפֿינט זיך, כאָטש ס׳איז דאָ גאָרנישט צווישן די קאַנטיקלעך וואָס צו זוכן. כּדי צו זוכן אַן אות-באותיק קאַנטיקלעך, וויקל זיי אַרום אין טאָפּל-ציטירלעך: `"( )"`.
