...
search-invalid-flag-2 = `flag:` (ד״ה, סימן) מוז ווערן נאָכגעקומען פֿון אַ סימן-נומער וואָס איז חל: `1` (רויט), `2` (אָראַנזש), `3` (גרין), `4` (בלאָ), `5` (ראָזע), `6` (טורקיזן), `7` (פּערפּל) אָדער `0` (קיין סימן).
