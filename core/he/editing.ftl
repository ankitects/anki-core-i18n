...
editing-attach-picturesaudiovideo = הצמד תמונות/שמע/וידאו
...
editing-media = מדיה
editing-ordered-list = רשימה
editing-outdent = הקטן הזחה
editing-paste = הדבק
editing-record-audio = הקלט שמע
editing-remove-formatting = הסר עיצוב
editing-set-text-color = בחר צבע טקסט
editing-set-text-highlight-color = בחר צבע רקע לטקסט
...
editing-underline-text = כתב מחוק
editing-unordered-list = רשימה אקראית
