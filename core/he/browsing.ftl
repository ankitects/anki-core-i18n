...
browsing-tooltip-note-modified = הפעם האחרונה שבוצעו שינויים בהערה, בדרך כלל תוכן שדה או עריכות תגים
browsing-tooltip-card = השם של תבנית הכרטיס
browsing-tooltip-cards = מספר הכרטיסים שיש להערה
browsing-tooltip-notetype = השם של סוג ההערה
