...
deck-config-interday-step-priority-tooltip =
    ...
    אבל כרטיסים בלמידה תמיד ייאספו תחילה.
...
deck-config-review-sort-order-tooltip =
    ...
    שאם יש לך הרבה חזרות, החזרות הממתינות במשך הזמן הרב ביותר יופיעו
    בתחילה. אם יש לך כמות חזרות גדולה שיעברו יותר מכמה ימים עד
