...
deck-config-interday-step-priority-tooltip =
    ...
    במידה וכמות הכרטיסים לחזרה וללמידה עוקפים את המגבלה היומית, המגבלה תחול על הכרטיסים לחזרה ולא על אלה שללמידה. הגדרה זו משפיעה על הסדר שבו יוצגו הכרטיסים לאחר שנקבע אילו כרטיסים יופיעו היום במסגרת המגבלה היומית, אבל לא תשפיע על אילו כרטיסים לא יופיעו כלל.
...
deck-config-review-sort-order-tooltip =
    ...
    לך מספר ימים לסיים אותה עד שתסיים אותה או שאתה מעוניין לראות
    כרטיסים לפי הסדר של תתי החפיסות, ייתכן שתמצא את הפקודות מיון
    החליפיות עדיפות.
...
deck-config-starting-ease-tooltip =
    ...
    חדש שנלמד יגדיל את המרווח עד לחזרה הבאה פי 2.5 מהעיכוב הקודם.
