...
deck-config-desired-retention-tooltip =
    ...
    הרבה חומר.
deck-config-desired-retention-tooltip2 = ערכי עומס העבודה המסופקים על ידי הבועה הם קירוב גס. לרמת דיוק גבוהה יותר, השתמש בסימולטור.
deck-config-historical-retention-tooltip =
    כאשר חלק מהיסטוריית החזרות שלך חסר, FSRS צריך להשלים את החסר. כברירת מחדל, זה יהיה
    בהנחה שכשעשית את החזרות הישנות האלה, זכרת 90% מהחומר. אם השמירה הישנה שלך
