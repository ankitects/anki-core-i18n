...
preferences-not-logged-in = Bei AnkiWeb im Moment nicht angemeldet.
preferences-login-successful-sync-now = Anmeldung erfolgreich. Einstellungen sichern und jetzt synchronisieren?
