...
search-invalid-flag-2 = Nach `flag:` muss eine gültige Flag-/Markierungsnummer eingetragen werden : `1` (rot), `2` (orange), `3` (grün), `4` (blau), `5` (rosa), `6` (türkis), `7` (violett) or `0` (keine Markierung).
