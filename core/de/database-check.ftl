...
database-check-new-card-high-due =
    { $count ->
        [one] Es wurde { $count } neue Karte mit einer Positionsnummer >= 1.000.000 gefunden – bitte ziehen Sie die Änderung der Positionsnummer dieser Karte in der Kartenverwaltung in Betracht.
       *[other] Es wurden { $count } neue Karten mit einer Positionsnummer >= 1.000.000 gefunden – bitte ziehen Sie die Änderung der Positionsnummern dieser Karten in der Kartenverwaltung in Betracht.
    }
