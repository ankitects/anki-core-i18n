...
importing-rows-had-num1d-fields-expected-num2d = '%(row)s' içinde %(num1)d alan vardı, beklenen %(num2)d
...
importing-the-first-field-of-the-note = Not türünün ilk alanı eşleştirilmelidir.
